...
class OpenApiLibraryGenerator {
  ...
  final _openApiRequest = refer(
    'OpenApiRequest',
    'package:openapi_base/openapi_base.dart',
  );
  final _openApiResponse = refer(
    'OpenApiResponse',
    'package:openapi_base/openapi_base.dart',
  );
  ...
  final _openApiEndpoint = refer(
    'ApiEndpoint',
    'package:openapi_base/openapi_base.dart',
  );
  final _endpointProvider = refer(
    'ApiEndpointProvider',
    'package:openapi_base/openapi_base.dart',
  );
  final _openApiUrlEncodeMixin = refer(
    'OpenApiUrlEncodeMixin',
    'package:openapi_base/openapi_base.dart',
  );
  final _openApiClient = refer(
    'OpenApiClient',
    'package:openapi_base/openapi_base.dart',
  );
  final _openApiClientBase = refer(
    'OpenApiClientBase',
    'package:openapi_base/openapi_base.dart',
  );
  final _hasSuccessResponse = refer(
    'HasSuccessResponse',
    'package:openapi_base/openapi_base.dart',
  );
  ...
  final _openApiClientRequest = refer(
    'OpenApiClientRequest',
    'package:openapi_base/openapi_base.dart',
  );
  final _openApiClientResponse = refer(
    'OpenApiClientResponse',
    'package:openapi_base/openapi_base.dart',
  );
  final _openApiRequestSender = refer(
    'OpenApiRequestSender',
    'package:openapi_base/openapi_base.dart',
  );
  final _responseMapType = refer(
    'ResponseMap',
    'package:openapi_base/openapi_base.dart',
  );
  final _securityRequirement = refer(
    'SecurityRequirement',
    'package:openapi_base/openapi_base.dart',
  );
  ...
  final _securitySchemeHttp = refer(
    'SecuritySchemeHttp',
    'package:openapi_base/openapi_base.dart',
  );
  final _securitySchemeHttpScheme = refer(
    'SecuritySchemeHttpScheme',
    'package:openapi_base/openapi_base.dart',
  );
  final _securitySchemeApiKey = refer(
    'SecuritySchemeApiKey',
    'package:openapi_base/openapi_base.dart',
  );
  final _openApiContentType = refer(
    'OpenApiContentType',
    'package:openapi_base/openapi_base.dart',
  );
  ...
  final _apiUuidJsonConverter = refer(
    'ApiUuidJsonConverter',
    'package:openapi_base/openapi_base.dart',
  );
  final _freezed = refer(
    'freezed',
  ...
  Library generate() {
    ...
    final providerClosure = Method(
      (mb) => mb
        ..lambda = true
        ..requiredParameters.add(Parameter((pb) => pb..name = 'ref'))
        ..body = refer('StateError')([
          literalString('must be overwritten'),
        ]).thrown.code,
    ).closure;
    final clientProviderName = '${baseName}ClientProvider'.camelCase;
    if (generateProvider) {
      lb.body.add(
        declareFinal(clientProviderName)
            .assign(
              _provider.addGenerics(refer(clientInterface.name!.pascalCase))([
                providerClosure,
              ]),
            )
            .statement,
    ...
    clientInterface.constructors.add(
      Constructor(
        (cb) => cb
          ..factory = true
          ..requiredParameters.addAll(
          ...
          ..body = refer(
            clientClass.name!,
          ).newInstanceNamed('_', fields.map((f) => refer(f.key))).code,
      ),
    );
    final c = Class((cb) {
      cb.name = baseName;
      ...
      for (final path in api.paths!.entries) {
        for (final operation in path.value!.operations.entries) {
          ...
          for (final response in operation.value!.responses!.entries) {
            ...
            mapMethod.optionalParameters.add(
              Parameter(
                (pb) => pb
                  ..name = 'on$codeName'
            ...
            final constructor = Constructor((cb) {
              ...
              if (statusAsParameter) {
                cb
                  ...
                  ..initializers.add(
                    refer('status').assign(refer('status')).code,
                  );
                clientResponseParseParams.add(
                  refer('response').property('status'),
                );
              } else {
                cb.initializers.add(
                  refer(
                    'status',
                  ).assign(literalNum(int.parse(response.key))).code,
                );
              }
              final content =
              ...
              if (content != null) {
                ...
                responseContentTypeAssignment = _openApiContentType
                    .newInstanceNamed('parse', [
                      literalString(responseContentType.toString()),
                    ])
                    .code;
                ...
                if (responseSchema.type == APIType.string) {
                  ...
                  cb.initializers.add(
                    refer('bodyJson').assign(literalMap({})).code,
                  );
                        ...
                        .property('map')([
                          Method((mb) {
                            mb.requiredParameters.add(
                              Parameter((pb) => pb..name = 'item'),
                            );
                            mb.lambda = true;
                            mb.body = bodyItemType.newInstanceNamed(
                              'fromJson',
                              [
                                refer('item').asA(
                                  _referType(
                  ...
                  cb.initializers.add(
                    refer(
                      'bodyJson',
                    ).assign(refer('body').property('toJson')([])).code,
                  );

                  clientResponseParseParams.add(
                    bodyType.newInstanceNamed('fromJson', [
                      refer(
                        'response',
                      ).property('responseBodyJson')([]).awaited,
                    ]),
                  );
                }
                responseCodeClass.fields.add(
                  Field(
                    (fb) => fb
                      ..name = 'body'
                      ..type = bodyType
                ...
                if (response.value!.content?.length == 1) {
                  ...
                  final responseContentType = OpenApiContentType.parse(
                    responseContent.key,
                  );
                  responseContentTypeAssignment = _openApiContentType
                      .newInstanceNamed('parse', [
                  ...
                  if (responseContent.key.contains('*')) {
                    ...
                    clientResponseParseParams.add(
                      refer(
                        'response',
                      ).property('responseContentType')([]).nullChecked,
                    );
                  }
                  cb.requiredParameters.add(
                    Parameter(
                  ...
                  if (_typeString == bodyType) {
                    responseCodeClass.implements.add(
                      _openApiResponseBodyString,
                    );
                    clientResponseParseParams.add(
                      refer(
                        'response',
                      ).property('responseBodyString')([]).awaited,
                    );
                  } else if (_uint8List == bodyType) {
                    responseCodeClass.implements.add(
                      _openApiResponseBodyBinary,
                    );
                    clientResponseParseParams.add(
                      refer(
                        'response',
                      ).property('responseBodyBytes')([]).awaited,
                    );
                  } else {
                    throw StateError(
            ...
            responseCodeClass.constructors.add(
              (constructor.toBuilder()
                    ..requiredParameters.map(
                      (pb) =>
                          (pb.toBuilder()..type = pb.toThis ? null : pb.type)
                              .build(),
                    ))
                  .build(),
            );
            responseCodeClass.methods.add(
              Method(
                (mb) => mb
                  ...
                  ..body = literalMap(
                    Map.fromEntries(
                      responseCodeClass.fields.build().map(
            ...
            responseClass.constructors.add(
              (constructor.toBuilder()
                    ..factory = true
                    ..initializers.clear()
                    ..requiredParameters.map(
                      (pb) => (pb.toBuilder()..toThis = false).build(),
                    )
            ...
            clientResponseParse[response.key] = Method(
              (mb) => mb
          ...
          if (successApiResponse != null) {
            ArgumentError.checkNotNull(
              successResponseCodeType,
              'successResponseCodeType',
            );
            responseClass.implements.add(
              _hasSuccessResponse.addGenerics(successResponseBodyType ?? _void),
            );
            responseClass.methods.add(
              Method(
                (mb) => mb
                  ..name = 'requireSuccess'
                  ..addDartDoc(
                    successApiResponse!.value!.description,
          ...
          cb.methods.add(
            Method((mb) {
              ...
              for (final param in allParameters) {
                ...
                clientDataConstructor.optionalParameters.add(
                  p.rebuild(
                    (pb) => pb,
                    // ..toThis = true
                  ),
          ...
          if (generateProvider && operation.key.toLowerCase() == 'get') {
            ...
            final m = Method((mb) {
              ...
              mb.body = Block.of([
                declareFinal('client')
                    .assign(
                      refer('ref').property('watch')([
                        refer(clientProviderName),
                      ]),
                    )
                    .statement,
                refer('Stream')
  ...
  Expression _writeToRequest(
    ...
    switch (location) {
      case APIParameterLocation.query:
        return request.property('addQueryParameter')([
          literalString(name),
          value,
        ]);
      case APIParameterLocation.header:
        return request.property('addHeaderParameter')([
          literalString(name),
          value,
        ]);
      case APIParameterLocation.path:
        return request.property('addPathParameter')([
          literalString(name),
          value,
        ]);
      case APIParameterLocation.cookie:
        return request.property('addCookieParameter')([
          literalString(name),
          value,
        ]);
    }
  ...
  void _createRequestBody(
    ...
    void addRequestBody(
      Reference bodyType,
      Expression encodeBody,
      Expression? decodeBody,
    ) {
      ...
      clientMethod.requiredParameters.add(
        Parameter(
          (pb) => pb
            ..name = 'body'
            ..type = bodyType,
    ...
    if (contentType.matches(OpenApiContentType.textPlain)) {
      ...
      final reference = _toDartType(
        '${operationName.pascalCase}Schema',
        schema,
      );

      final bodyIsObject = schema.type == null || schema.type == APIType.object;

      final readJsonBodyMethodName = bodyIsObject
          ? 'readJsonBody'
          : 'readJsonBodyDynamic';
      final mapExpression = contentType.matches(OpenApiContentType.json)
          ...
          : (contentType.matches(OpenApiContentType.urlencoded)
                ? refer(
                    'request',
                  ).property('readUrlEncodedBodyFlat')([]).awaited
        ...
        [
          ...
          Method(
            (mb) => mb
              ...
              ..body = Block.of([handler!.awaited.returned.statement]),
          ).closure,
        ],
    ...
    return literalList(
      security?.map(
            (security) => _securityRequirement([], {
              'schemes': literalList(
                security!.requirements.entries.map(
                  (req) => _securityRequirementScheme.newInstance([], {
                    'scheme': refer(
                      securitySchemesClass.name!,
  ...
  Reference _schemaReference(String key, APISchemaObject schemaObject) {
    ...
    final found = createdSchema.values.firstWhereOrNull(
  ...
  Class _createSchemaClass(String className, APISchemaObject obj) {
    ...
    final additionalPropertyType = switch ((
      additionalPropertyPolicy,
      additionalPropertySchema,
    )) {
      (null, _) => null,
      (APISchemaAdditionalPropertyPolicy.disallowed, _) => null,
      (APISchemaAdditionalPropertyPolicy.freeForm, _) => _referType(
        'Object',
        isNullable: true,
      ),
      (
    ...
    required.forEach((element) {
      if (fields[element] == null) {
        throw StateError(
          'Invalid required "$element" was not '
    ...
    final c = Class((cb) {
      ...
      Expression? fromJsonExpression = refer(
      ...
      for (final requiredKey in required) {
        if (!fields.keys.contains(requiredKey)) {
          throw StateError(
            '$requiredKey defined as required for $className -'
        ...
        cb.methods.add(
          Method(
            (mb) => mb
              ...
              ).index(refer('key')).assign(refer('value')).code,
          ),
        );
        cb.methods.add(
          Method(
          ...
          Field(
            (fb) => fb
              ...
              ..assignment = _securitySchemeHttp.newInstance([], {
                'scheme': _securitySchemeHttpScheme.property('bearer'),
              }).code,
          ),
        );
              ...
              ..assignment = _securitySchemeApiKey.newInstance([], {
                ...
                'readFromRequest': Method(
                  (mb) => mb
                    ...
                    ..body = _readFromRequest(location, valueName).code,
                ).closure,
                'writeToRequest': Method(
                  (mb) => mb
                    ..requiredParameters.add(
                      Parameter(
                        (pb) => pb
  ...
  Expression _parseJson({
    ...
    final schemaType =
        schema.type ?? APIType.object; /*ArgumentError.checkNotNull(
                ...
                Method(
                  (mb) => mb
                    ...
                    ..body = _parseJson(
                      ...
                      schema: itemSchema,
                      type: _toDartType('${parentName}ListItem', itemSchema),
                      expression: refer('e'),
                    ).code,
                ).closure,
              ])
  ...
  Expression _decodeStringType({
    ...
    if (schema.format == 'uuid') {
      ...
      return refer('${paramEnumType.symbol!}Ext').property('fromName')([
        asString,
      ]);
              ...
              .property('map')([
                Method(
                  (mb) => mb
                    ...
                    ..requiredParameters.add(Parameter((pb) => pb..name = 'e'))
                    ..body = refer(
                      '${paramEnumType.symbol!}Ext',
                    ).property('fromName')([refer('e')]).code,
                ).closure,
              ])
              .property('toList')([]);
...
class OpenApiCodeBuilderUtils {
  static Map<String, dynamic>? _loadYaml(String source) {
    ...
    try {
      ...
      _logger.severe(
        'Error converting yaml tree to map objects.',
        e.cause ?? e,
        stackTrace,
      );
      rethrow;
  ...
  static String formatLibrary(
    ...
    final libraryOutput = DartFormatter(languageVersion: Version(3, 2, 0)).format(
...
Block ifStatement(Expression conditional, Code body, {Code? elseCode}) =>
    Block.of([
      ...
      const Code(') {'),
      body,
      if (elseCode != null) ...[const Code('} else {'), elseCode],
      const Code('}'),
    ]);
